...
class BeaconExample : Application() {
...
//        beaconManager.setEnableScheduledScanJobs(false);
        ...
        // UUID 설정
        region = Region("all-beacons",
            Identifier.parse("020012AC-4202-649D-EC11-B6CBC8814AD7"),
            null,
            null)
    ...
    private fun sendNotification() {
        val builder = NotificationCompat.Builder(this, "beacon-ref-notification-id")
            .setContentTitle("Beacon Reference Application").setContentText("A beacon is nearby.")
